            ...
            foreach (var link in links)
            {
                ...
                if (href != null)
                {
                    if (href.StartsWith("http://") || href.StartsWith("https://") || href.StartsWith("www") || href.StartsWith("//"))
                    {
                        ...
                        if (!href.StartsWith("//"))
                        {
                            if (SpeedURL.URLExists(href))
                            {
                                siteMap.Add(new Site_Map() { UrlSite = href });
                            }
                        }
                        else
                        {
                            ...
                            {
                                if (SpeedURL.URLExists(ResponseUriSite(href).ToString()))
                                {
                    ...
                    else
                    {
                        ...
                        {
                            if (SpeedURL.URLExists(url + href))
                            {
                                siteMap.Add(new Site_Map() { UrlSite = url + href });
                            }
